export const SkillsData = [
    {
        name: "HTML",
        desc: "HTML을 이용해 웹페이지를 만들고 구조를 짤 수 있습니다.",
    ...
    {
        name: "TypeScript",
        desc: "타입스크립트는 코드에 목적을 명시할수 있다는 점에서 매우 관심이 가는 기술스택입니다. 현재 웹사이트도 최근에 타입스크립트를 적용하였습니다.",
        img: "/images/landing/skills/ts.png",
        imgStyle: { width: "95px" },
    ...
    {
        name: "JQuery",
        desc: "JQuery를 사용하여 DOM을 조작하거나, 동적으로 CSS를 꾸밀 수 있습니다.",
        img: "/images/landing/skills/jquery.png",
        imgStyle: { borderRadius: "10px", width: "70px" },
        proficiency: 2, // 1: 하, 2:중, 3:상
    },
    {
        name: "REST API & Axios",
        desc: "Axios를 이용해 REST API를 호출하여, 비동기 통신을 할 수 있습니다. ",
        img: "/images/landing/skills/rest.png",
        imgStyle: { borderRadius: "10px", width: "70px" },
        proficiency: 2, // 1: 하, 2:중, 3:상
    },
    {
        name: "ReactQuery",
        desc: "현재 웹사이트의 방문로그 페이지를 ReactQuery를 적용한 경험을 했으며, 탭간 이동이나 데이터의 변화가 있으면, 자동으로 Re Fetch 되게 되어있습니다.",
        img: "/images/landing/skills/tanstack.svg",
        imgStyle: { borderRadius: "10px", width: "70px" },
    ...
    {
        name: "Socket.io",
        desc: "Socket.io를 사용하여 실시간 채팅을 만든 경험이 있습니다.",
        img: "/images/landing/skills/socket.png",
        imgStyle: { borderRadius: "10px", width: "70px" },
        proficiency: 1, // 1: 하, 2:중, 3:상
    },
];
